...
class Database:
    ...
    def init_database(self):
        ...
        with self.get_connection() as conn:
            ...
            cursor.execute('''
                           INSERT
                           OR IGNORE INTO clients (client_name) VALUES ('Unassigned')
                           ''')
    ...
    def _create_default_user(self, cursor):
        ...
        cursor.execute('''
                       INSERT
                       OR IGNORE INTO users (username, password_hash) VALUES (?, ?)
    ...
    def add_or_update_domain(self, domain_name: str, client_id: Optional[int] = None) -> int:
        ...
        with self.get_connection() as conn:
            ...
            if existing:
                ...
                cursor.execute('''
                               INSERT
                               OR IGNORE INTO domains (domain_number, domain_name, client_id)
                    VALUES (?, ?, ?)
